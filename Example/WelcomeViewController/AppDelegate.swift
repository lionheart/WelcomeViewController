...
class AppDelegate: UIResponder, UIApplicationDelegateWithWindow {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        rootViewController = WelcomeViewController<WelcomeItem>(header: "TV", paragraph: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat", buttonText: "Continue", secondaryButtonText: "Cancel", callouts: [.library, .watchNow, .store], delegate: nil)
        return true
    }
}
